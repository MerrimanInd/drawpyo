...
output_path = os.path.join(os.getcwd(), "coffee_grinder_chart.drawio")
...
title_format = TextFormat(fontColor="#000000", fontSize=16, align="center", verticalAlign="bottom", bold=True)
base_text_format = TextFormat(fontColor="#666666", fontSize=14, align="center", verticalAlign="bottom")
inside_text_format = TextFormat(fontColor="#000000", fontSize=16, align="center", verticalAlign="bottom", bold=True)
